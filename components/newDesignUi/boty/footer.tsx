      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:08065064810" className="md:hidden flex items-center gap-2 text-sm text-white/60 hover:text-white boty-transition">
                  <img src="/_boty-images/Call white.svg" alt="Call" className="w-6 h-6 flex-shrink-0" />
                  08065064810
                </a>
                <a href="tel:08065064810" className="hidden md:flex items-center gap-2 text-sm text-white/60 hover:text-white boty-transition">
                  <img src="/_boty-images/Call white.svg" alt="Call" className="w-4 h-4 flex-shrink-0" />
                  08065064810
                </a>
              </li>
              <li>
